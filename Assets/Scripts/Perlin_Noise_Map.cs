...
public class Perlin_Noise_Map : MonoBehaviour
{
     Dictionary<int, GameObject> tileset;
    Dictionary<int, GameObject> tile_groups;
    public GameObject prefab_3dots;
    public GameObject prefab_black;
    public GameObject prefab_flower;
    public GameObject prefab_plants;
    ...
    void CreateTileset()
    {
        ...
        tileset.Add(0, prefab_plants);
        tileset.Add(1, prefab_3dots);
        tileset.Add(2, prefab_black);
        tileset.Add(3, prefab_flower);
    }
